            ...
            (lambda () 
              ...
              (setq reftex-label-alist
                    ...
                    '(
                      ...
                      ("definitionenum" ?D "def:" "\\ref{%s}" 1 ("definition" "def.") nil)
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq ido-ignore-files
   (append
    ...
    '("\\.o$" "\\.hi$" ) 
    ;; TEX
    '("\\.toc$" "\\.out$" "\\.log$" "\\.blg$" "\\.bbl$" "\\.aux$" "\\.bcf$" "\\.nav$" "\\.snm$" "\\-blx.bib$" "\\.synctex.gz$" "\\.run.xml$" "\\.fmt$" "\\.loe$" "\\.prv/")
    ido-ignore-files))  
#+END_SRC
*** Files
**** Other's 
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key mutt-mode-map (kbd "C-x #") 'save-and-server-edit)
  (define-key mutt-mode-map (kbd "C-x k") 'save-and-server-edit)
