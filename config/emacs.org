...
#+BEGIN_SRC emacs-lisp
  (eval-after-load "grep"
    '(grep-apply-setting
      'grep-find-command
      "find . ! -name \"*~\" ! -name \"#*#\" ! -path \"*/.svn/*\" ! -path \"*/.git/*\" -type f -print0 | xargs -0 -e grep -nH -ie " )
    )
#+END_SRC
...
- /I :: Deaktivate case-replace :%s/.*/aaa/I
...
#+BEGIN_SRC emacs-lisp
  ...
  (eval-after-load 'latex
    '(progn    
        ...
        (define-key LaTeX-mode-map
          [f6] (tex-build-command-function "Biber" nil t))
        (define-key LaTeX-mode-map
...
#+END_SRC
*** dired-details
hide details from listing (dired-details-toggle)
