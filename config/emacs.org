...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-agenda-files (list org-directory "/home/data/promotion" "/home/data/personal/Webdesign Gerer"))
...
;;               '("equation") ;;has no effect, for already in the list?
               ...
               (setq reftex-insert-label-flags (quote ("shladcm" "sfhladcm")))
               (setq reftex-label-alist 
                     ;; find out code using (string-to-char "m")
