...
(xbindkey '(XF86AudioRaiseVolume) "audio-cli vol +10%")
(xbindkey '(XF86AudioLowerVolume) "audio-cli vol -10%")
(xbindkey '(shift XF86AudioRaiseVolume) "audio-cli vol +5%")
(xbindkey '(shift XF86AudioLowerVolume) "audio-cli vol -5%")
...
(xbindkey '(shift Mod4 Escape) "dmenu_session")
(xbindkey '(shift Mod4 F1) "dmenu_session 1")
(xbindkey '(shift Mod4 F2) "dmenu_session 2")
(xbindkey '(shift Mod4 F3) "dmenu_session 3")
(xbindkey '(shift Mod4 F4) "dmenu_session 4")
(xbindkey '(shift Mod4 F5) "dmenu_session 5")
(xbindkey '(shift Mod4 F6) "dmenu_session 6")
(xbindkey '(shift Mod4 F7) "dmenu_session 7")
